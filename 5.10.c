...
int main() {
    ...
    int count_1000, count_500, count_100, count_50, count_20, count_10, count_5, count_1 ;

    printf("Enter Total Cost (intrgrt) : ") ;
    scanf("%d", &total_cost) ;
    ...
    if(change_amount == -1) {
        printf("\nERROE : Amount Paid is less than Total Cost.\n") ;
        return 1 ;
    }
    ...
    if(count_100 > 0) printf("100 Bath : %d", count_100) ;
